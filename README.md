...
1) Mostrar el mapa: Para esta opción se muestra por pantalla cada uno de los vértices (zonas) del mapa y sus diferentes aristas (caminos) a cada uno de las zonas enlazadas.
